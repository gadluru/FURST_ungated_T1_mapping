function step_size = line_search_IR(old, update, Data, para)

%--------------------------------------------------------------------------
%   step_size = line_search_IR(old, update, Data, para)
%--------------------------------------------------------------------------
...
for i=1:max_try
    ...
    fidelity_new = compute_fidelity_for_line_search_IR(new,Data,para);
    [~,cost_new] = Cost_STCR_IR(new,fidelity_new,para); clear fidelity_new
